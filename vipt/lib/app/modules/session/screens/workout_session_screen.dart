...
class _WorkoutSessionScreenState extends State<WorkoutSessionScreen> {
                      ...
                      child: Padding(
                        ...
                        child: ClipRect(
                          child: Stack(
                            ...
                            clipBehavior: Clip.hardEdge,
                            children: [
                              Center(child: _buildMediaPlayer()),
  ...
  Widget _buildMediaPlayer() {
    // Hiển thị loading khi đang khởi tạo video
    if (isInitVideo && !hasVideoError) {
      return const Center(
  ...
  Widget _buildCollectionTimer() {
    return MyCircularCountDownTimer(
      ...
      textStyle: Theme.of(context).textTheme.bodyMedium!.copyWith(fontSize: 10),
      isReverse: true,
      isReverseAnimation: false,
      autoStart: false,
      onStart: () {},
