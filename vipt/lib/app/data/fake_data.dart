...
Map<String, String> _mealNameToID = {};
Map<String, String> _workoutCategoryNameToID = {};
Map<String, String> _workoutEquipmentNameToID = {};
class MealData {
  final String name;
  final String asset;
  ...
  final Map<String, String> ingredientNameToAmount;
  ...
  MealData({
    ...
    required this.steps,
    required this.ingredientNameToAmount,
  });
}
...
List<dynamic> mealFakeData = [
  MealData(
    name: 'Apple Sauce Oatmeal',
    asset: '', // Placeholder - will be replaced with Cloudinary URL
  ...
  MealData(
    ...
    asset:
        '', // Placeholder - will be replaced with Cloudinary URLoatmeal_with_apples_raisins.png?alt=media&token=0dfc1a8d-a729-4267-b8dd-3fb3612a4265',
    categoryNames: ['Breakfast'],
    cookTime: 7,
    steps: [
      '1. Cover oat flakes with double the amount of water.',
  ...
  MealData(
    ...
    asset:
        '', // Placeholder - will be replaced with Cloudinary URLquinoa_with_banana.png?alt=media&token=4f484fda-1efa-4e27-8390-2b77556abd49',
    categoryNames: ['Breakfast'],
    cookTime: 20,
    steps: [
  ...
  MealData(
    ...
    asset:
        '', // Placeholder - will be replaced with Cloudinary URLprotein_cauliflower_bites.png?alt=media&token=32e1e765-5c36-4765-bbc2-58fd557cb7c8',
  ...
  MealData(
    ...
    asset:
        '', // Placeholder - will be replaced with Cloudinary URLbroccoli_cauliflower_curry_with_rice.png?alt=media&token=257a2302-ecc8-42d0-a1c5-1453af056ecc',
    categoryNames: ['Lunch/Dinner'],
    cookTime: 50,
    steps: [
  ...
  MealData(
    name: 'Air-Fried Tofu',
    asset:
        '', // Placeholder - will be replaced with Cloudinary URLair_fried_tofu.png?alt=media&token=825f9ff2-0daf-4523-b031-dc458e9f86da',
    categoryNames: ['Lunch/Dinner'],
    cookTime: 25,
    steps: [
  ...
  MealData(
    ...
    asset:
        '', // Placeholder - will be replaced with Cloudinary URLquinoa_sweet_potato.png?alt=media&token=38246d65-012d-4980-9bcb-98a54dedcd37',
    categoryNames: ['Lunch/Dinner'],
    cookTime: 45,
    steps: [
  ...
  MealData(
    ...
    asset:
        '', // Placeholder - will be replaced with Cloudinary URLsweet_potato_curry_with_rice.png?alt=media&token=adb72f95-a1aa-4c99-abb2-a24182b5d336',
    categoryNames: ['Lunch/Dinner'],
    cookTime: 50,
    steps: [
      '1. Rinse rice really well. Transfer the rice to a cooking pot. Cover with double the amount of water, season for taste and stir once. Bring water to a boil then lower heat to low. Cover with a lid and simmer until it has completely absorbed the water. It will take ~ 20 minutes for white rice; 35 minutes for brown rice.',
  ...
  Meal(
    ...
    name: 'Mushroom Steak',
    asset:
        '', // Placeholder - will be replaced with Cloudinary URLmushroom_steak.png?alt=media&token=cc69cb11-6c9c-44c7-886e-3840558b0211',
  ...
  Meal(
    ...
    asset:
        '', // Placeholder - will be replaced with Cloudinary URLmushroom_walnut_burger.png?alt=media&token=e03f5a23-13e2-4dcf-9370-40327a0bb19f',
    categoryIDs: ['N4l3MZe2OXxMgY92Fgyz'],
    cookTime: 40,
    steps: [
      '1. Place all of the ingredients into a food processor. Season for taste.',
  ...
  Meal(
    ...
    asset:
        '', // Placeholder - will be replaced with Cloudinary URLcarrot_cake_bites.png?alt=media&token=bdd22047-ab25-4f24-adc0-18f298bb39e7',
  ...
  Meal(
    ...
    asset:
        '', // Placeholder - will be replaced with Cloudinary URLraw_gingerbread_bites.png?alt=media&token=d8e8c4ca-c2e6-4b28-b1fe-ade52d27d0a5',
    categoryIDs: ['UrMFD5dZYHMvcQ4t9ed4'],
    cookTime: 15,
    steps: [
  ...
  Meal(
    ...
    asset:
        '', // Placeholder - will be replaced with Cloudinary URLbuckwheat_bread.png?alt=media&token=cfd4405b-f8b8-4c9d-93b7-104e58e331a1',
    categoryIDs: ['UrMFD5dZYHMvcQ4t9ed4'],
    cookTime: 75,
    steps: [
  ...
  Meal(
    ...
    name: 'Onion Rings',
    asset:
        '', // Placeholder - will be replaced with Cloudinary URLonion_rings.png?alt=media&token=f638bb8f-1dfe-4d6a-9853-79611a7ded99',
    categoryIDs: ['UrMFD5dZYHMvcQ4t9ed4'],
    cookTime: 35,
    steps: [
  ...
  Meal(
    ...
    asset:
        '', // Placeholder - will be replaced with Cloudinary URLpumpkin_oat_bites.png?alt=media&token=9ae62482-d123-4a5c-b28c-1f253d715734',
    categoryIDs: ['UrMFD5dZYHMvcQ4t9ed4'],
    cookTime: 15,
    steps: [
      '1. Add all of the ingredients to a bowl. Note: If you don/’t have oat flour you can use a blender and grind rolled oats into flour first.',
  ...
  Meal(
    ...
    name: 'Apple Nachos',
    asset:
        '', // Placeholder - will be replaced with Cloudinary URLapple_nachos.png?alt=media&token=ee1e2337-e176-4be1-a5dd-0697194b084e',
    categoryIDs: ['UrMFD5dZYHMvcQ4t9ed4'],
    cookTime: 7,
    steps: [
  ...
  Meal(
    ...
    asset:
        '', // Placeholder - will be replaced with Cloudinary URLroasted_chickpeas.png?alt=media&token=ad619084-5a5e-4f75-967a-9c2d09de565f',
    categoryIDs: ['UrMFD5dZYHMvcQ4t9ed4'],
    cookTime: 30,
    steps: [
...
List<MealCollection> mealCollectionFakeData = [
  MealCollection(
      ...
      note: '',
      asset: '', // Placeholder - will be replaced with Cloudinary URL
      dateToMealID: {} // Will be populated with dynamic meal IDs during seeding
      )
];

List<Category> workoutCategoryFakeData = [
  Category('', name: "Yoga", asset: '', parentCategoryID: null),
  Category('', name: "Full Body", asset: '', parentCategoryID: null),
  Category('', name: "Upper Body", asset: '', parentCategoryID: null),
  Category('', name: "Lower Body", asset: '', parentCategoryID: null),
  Category('', name: "Core", asset: '', parentCategoryID: null),
  Category('', name: "Cardio", asset: '', parentCategoryID: null),
];

List<WorkoutEquipment> workoutEquipmentFakeData = [
  WorkoutEquipment(null, name: "No Equipment", imageLink: ""),
  WorkoutEquipment(null, name: "Dumbbells", imageLink: ""),
  WorkoutEquipment(null, name: "Barbell", imageLink: ""),
  WorkoutEquipment(null, name: "Resistance Band", imageLink: ""),
  WorkoutEquipment(null, name: "Bench", imageLink: ""),
  WorkoutEquipment(null, name: "Pull-up Bar", imageLink: ""),
];
...
Future<void> addFakeData() async {
  ...
  String generateLink(String name, String type, String extension) {
    return workoutProvider.generateLink(name, type, extension);
  }
  ...
  List<Workout> data = [
    ...
    Workout(null,
        ...
        breathing: 'Breathe deeply. Do not hold your breath.',
        muscleFocusAsset: generateLink('High Knees', type[2], muscleFocusType),
        categoryIDs: [
    ...
    Workout(null,
        ...
        breathing: 'Breathe in going down, breathe out going up.',
        muscleFocusAsset: generateLink('Plank Jacks', type[2], muscleFocusType),
        categoryIDs: [
          '4JX1H4ZFDkb85zQkA6df',
          'jOLYMcvtft5eUGyv2ciW',
          'Gwif2wxSJ4MCGh9xT9bs',
    ...
    Workout(null,
        ...
        breathing: 'Breathe deeply. Do not hold your breath.',
        muscleFocusAsset: generateLink('Rope Crunch', type[2], muscleFocusType),
        categoryIDs: ['D1MmmI7lu04PKWW6iiD3'],
        metValue: 4.5,
    ...
    Workout(null,
        ...
        muscleFocusAsset:
            generateLink('Smith Machine Calf Raise', type[2], muscleFocusType),
        categoryIDs: ['EG9GiBTRIc3gwXRklYtN'],
        metValue: 4.5,
        equipmentIDs: ['WkEV9tCQqNqtjbIXgIvn']),
    //
    ...
    Workout(null,
        ...
        muscleFocusAsset: generateLink('Triceps dip', type[2], muscleFocusType),
    ...
    Workout(null,
        ...
        muscleFocusAsset: generateLink(
            'Dumbbell front raise to lateral raise', type[2], muscleFocusType),
        categoryIDs: ['bX2VABYBtuJv2MyAp7Of'],
        metValue: 4.5,
    ...
    Workout(null,
        ...
        animation: generateLink('Dumbbell Bench Press', type[0], animationType),
        thumbnail: generateLink('Dumbbell Bench Press', type[1], thumbnailType),
  ...
  for (var item in data) {
    await workoutProvider.add(item);
  }
}

void updateFakeData() async {
  final workoutProvider = WorkoutProvider();
  List<Workout> list = await workoutProvider.fetchAll();
  list.map((e) {
    var s = e.thumbnail.replaceAll('.jpg', '.png');
    workoutProvider.update(
        e.id ?? '',
        Workout(e.id,
            name: e.name,
...
Future<void> seedMealCategories() async {
  final provider = MealCategoryProvider();

  try {
    for (var mealCategory in mealCatefakeData) {
      final category = Category(
        '',
        name: mealCategory.name,
        asset: mealCategory.asset,
        parentCategoryID: mealCategory.parentCategoryID,
      );

      final addedCategory = await provider.add(category);
      _categoryNameToID[category.name] = addedCategory.id!;
    }
  } catch (e) {
    rethrow;
  }
...
Future<void> seedIngredients() async {
  final provider = IngredientProvider();

  try {
    for (var ingredient in ingredientFakeData) {
      ...
      final addedIngredient = await provider.add(newIngredient);
      _ingredientNameToID[ingredient.name] = addedIngredient.id!;
    }
  } catch (e) {
    rethrow;
  }
...
Future<void> seedMeals() async {
  ...
  try {
    for (var item in mealFakeData) {
      ...
      if (item is MealData) {
        mealName = item.name;
        List<String> updatedCategoryIDs = [];
        for (var categoryName in item.categoryNames) {
          if (_categoryNameToID.containsKey(categoryName)) {
            updatedCategoryIDs.add(_categoryNameToID[categoryName]!);
          }
        }

        Map<String, String> updatedIngreIDToAmount = {};
        for (var entry in item.ingredientNameToAmount.entries) {
          final ingredientName = entry.key;
          final amount = entry.value;

          if (_ingredientNameToID.containsKey(ingredientName)) {
            updatedIngreIDToAmount[_ingredientNameToID[ingredientName]!] =
                amount;
          }
        }
        ...
        newMeal = Meal(
          ...
          name: item.name,
          asset: item.asset,
          categoryIDs: updatedCategoryIDs.isNotEmpty
              ? updatedCategoryIDs
              : [_categoryNameToID['Breakfast']!],
          cookTime: item.cookTime,
          steps: item.steps,
          ingreIDToAmount: updatedIngreIDToAmount,
        );
      } else {
        final oldMeal = item as Meal;
        ...
        newMeal = Meal(
          ...
          cookTime: oldMeal.cookTime,
          steps: oldMeal.steps,
          ingreIDToAmount: {},
        );
      }

      final addedMeal = await provider.add(newMeal);
      _mealNameToID[mealName] = addedMeal.id!;
    }
  } catch (e) {
    rethrow;
  }
...
Future<void> seedMealCollections() async {
  final provider = MealCollectionProvider();

  try {
    for (var collection in mealCollectionFakeData) {
      final newCollection = MealCollection(
        id: '',
      ...
      await provider.add(newCollection);
    }
  } catch (e) {
    rethrow;
  }
...
Future<void> seedWorkoutCategories() async {
  final provider = WorkoutCategoryProvider();

  try {
    for (var category in workoutCategoryFakeData) {
      final addedCategory = await provider.add(category);
      _workoutCategoryNameToID[category.name] = addedCategory.id!;
    }
  } catch (e) {
    rethrow;
  }
...
Future<void> seedWorkoutEquipment() async {
  final provider = WorkoutEquipmentProvider();

  try {
    for (var equipment in workoutEquipmentFakeData) {
      final addedEquipment = await provider.add(equipment);
      _workoutEquipmentNameToID[equipment.name] = addedEquipment.id!;
    }
  } catch (e) {
    rethrow;
  }
...
Future<void> seedAllFakeData() async {
  try {
