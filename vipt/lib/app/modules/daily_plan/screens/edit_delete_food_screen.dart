...
class EditDeleteFoodScreen extends StatelessWidget {
  ...
  final _controller = Get.find<EditDeleteLocalMealController>();
  ...
  Widget build(BuildContext context) {
    return Builder(builder: (context) {
      nameTextController.text = _controller.name;
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: () async {
                await _controller.deleteLocalMeal();
            ...
            IconButton(
              ...
              onPressed: () async {
                await _controller.editLocalMeal();
                Get.back(result: true);
              },
            ),
          ],
